/***************************************************************************
  Hydra ESP32_PLC Firmware v2.2 - Modern UI with SD Card Logging
  – All web content embedded in firmware
  – SD card logging for events and configuration
                        ...
                        <div class="status-card" id="statusDisplay">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-md-end mt-2 mt-md-0">
                                    ...
                                    <span class="badge bg-success me-2"><i class="bi bi-wifi me-1"></i> <span id="wifiStatus">Connected</span></span>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Repeat for all 8 digital inputs -->
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Repeat for all 8 digital outputs -->
                                </div>
                            </div>
                        </div>
                    </div>
...
void updateModbus() {
  ...
  mb.Ireg(0, readDigital(0));
  mb.Ireg(1, readDigital(1));
  mb.Ireg(2, readAnalog(0) >> 2); // Scale to 0-1023
...
void setup() {
  ...
  if(config.sdCardPresent && SD.exists(config.defaultLogicPath)) {
    loadScript(config.defaultLogicPath);
  }
